...
management and responsive design for cross-device support</p>
            ...
            {/* Project 5 */}
            <div className="glass p-6 rounded-xl border border-white/10 hover:-translate-y-1 text-center glass hover:border-cyan-400 hover:shadow-[0_0_20px_rgba(34,211,238,0.6)] transition duration-300 ease-in-out">
              <h3 className="text-xl font-bold mb-2 text-cyan-400">Text To Image Generator </h3>
              <p className="text-white mb-4">Work in Progress.....
                {/* A web application that converts user-inputted text into images using AI models. Built with HTML, CSS, JavaScript, and PHP, it allows users to generate unique images from text prompts, download results, and explore creative possibilities. */}
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {[].map((tech, key) => (
                  <span
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/kamalkori28/TextToImage-gen"
                  className="relative group text-white hover:text-cyan-400 transition-colors my-4"
                  target="_blank"
                >
                  View Project →
